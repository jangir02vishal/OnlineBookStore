    ...
    return (
        <div className="px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12">
            ...
            <div className="md:w-1/2 space-y-6">
                ...
                <p className="mb-10 text-lg md:w-5/6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae accusamus,
                     corporis cum beatae quidem expedita voluptate! Nesciunt est ea odit cupiditate
                      minima officiis. Reiciendis quibusdam fugit aperiam nihil neque quia!</p>
                {/* stats regarding store */}
                <div className="flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14">
                    ...
                    <div>
                        ...
                        <p className="text-base">Active book sellers</p>
                    </div>
                </div>
